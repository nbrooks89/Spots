...
export declare const resolveContainerRef: <T extends HTMLElement>(ref: T | import("../../@types/react").RefObject<T> | (() => T | import("../../@types/react").RefObject<T> | null) | null | undefined) => HTMLBodyElement | T | null;
