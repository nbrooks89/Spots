...
import { OverlayProps as BaseOverlayProps } from '../../react-overlays/esm/Overlay';
import { TransitionType } from './helpers';
export declare type Placement = import('../../react-overlays/esm/usePopper').Placement;
...
declare namespace Overlay {
    ...
    var defaultProps: {
        transition: React.ForwardRefExoticComponent<Pick<import("./Fade").FadeProps, React.ReactText> & React.RefAttributes<import("../../@types/react-transition-group/Transition").default<any>>>;
        rootClose: boolean;
        show: boolean;
        placement: string;
    };
